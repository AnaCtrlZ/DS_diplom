...
def send_request_to_vllm(api_url, prompt, model_name="default-model", max_tokens=150, temperature=0.4, headers=None, top_p=0.6,
    ...
    payload = {"model": model_name,
            "messages": [
                {"role": "system", "content": "Ты — менеджер по продажам, готовый помочь с различными вопросами. Твоя задача — анализировать предоставленные документы и формировать точные и информативные ответы на вопросы пользователей."},
